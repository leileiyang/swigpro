...
if _swig_python_version_info >= (2, 7, 0):
    def swig_import_helper():
        ...
        mname = '.'.join((pkg, '_mylib')).lstrip('.')
        try:
            return importlib.import_module(mname)
        except ImportError:
            return importlib.import_module('_mylib')
...
class Foo(_object):
    ...
    def __init__(self):
        ...
        try:
            ...
            self.this = this
    __swig_destroy__ = _mylib.delete_Foo
    def __del__(self):
        return None
Foo_swigregister = _mylib.Foo_swigregister
Foo_swigregister(Foo)


def bar(arg1):
    return _mylib.bar(arg1)
bar = _mylib.bar
