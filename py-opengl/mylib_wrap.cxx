...
SWIGINTERN PyObject *_wrap_bar(PyObject *SWIGUNUSEDPARM(self), PyObject *args) {
  ...
  if (!SWIG_IsOK(res1)) {
    SWIG_exception_fail(SWIG_ArgError(res1), "in method '" "bar" "', argument " "1"" of type '" "Foo const &""'"); 
  }
  if (!argp1) {
    SWIG_exception_fail(SWIG_ValueError, "invalid null reference " "in method '" "bar" "', argument " "1"" of type '" "Foo const &""'"); 
  }
  arg1 = reinterpret_cast< Foo * >(argp1);
  bar((Foo const &)*arg1);
  resultobj = SWIG_Py_Void();
